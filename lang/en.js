export default {
  ...
  checkoutSuccessText: "<p>We are pleased that you have chosen HEDO.</p><p>To be able to order even easier in the future, you just need to select a password and to verify your email address to create a customer account.</p>",
