<template>
  <div>
    <div
      v-if="attributes['custom:newsletter_consent'] != '1'"
      class="panel mb4"
    >
      <div class="mb4">
      ...
      <primary-button @click="subscribeNewsletter()">{{
    ...
    >
      ...
      <secondary-button @click="unsubscribeNewsletter()">{{
  ...
  methods: {
    async save() {
      try {
        ...
        this.$store.dispatch(
          ...
          this.$t("dataUpdatedNotification")
        );
    ...
    async unsubscribeNewsletter() {
      const confirmation = await this.$store.dispatch(
        "confirmDialog/ask",
        this.$t("newsletterUnsubscribeConfirm")
      );
      ...
      try {
        ...
        this.$store.dispatch(
          "notifications/success",
          this.$t("newsletterUnsubscribedNotification")
        );
    ...
    async subscribeNewsletter() {
      try {
        ...
        this.$store.dispatch(
          "notifications/success",
          this.$t("newsletterSubscribedNotification")
        );
    ...
    async changePassword() {
      ...
      try {
        ...
        this.$store.dispatch(
          "notifications/success",
          this.$t("passwordChangedNotification")
        );
      } catch (e) {
        console.log(e);
        if (e.name == "LimitExceededException")
