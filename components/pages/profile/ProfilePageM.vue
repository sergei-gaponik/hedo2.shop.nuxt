<template>
<div class="a-outer">
  <div class="a-container" :style="{ transform: pageVisible ? 'translateX(-100%)' : 'none' }">
    <div class="a-menu">
...
export default {
  components: { ChevronLeftIcon, ChevronRightIcon, AddressPage, OrdersPage, PersonalDataPage, PageTitleM, ListItem },
  computed: {
    pageTitle(){
      switch(this.page){
        case 'orders':
