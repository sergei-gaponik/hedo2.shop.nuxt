...
export default {
  ...
  data(){
    ...
    const brands = this.brands?.sort((a, b) => a.name.localeCompare(b.name)) || []
    ...
    const brandGroups = [ ...Array(cols).keys() ].map(a => brands.slice(a * n, (a + 1) * n))
