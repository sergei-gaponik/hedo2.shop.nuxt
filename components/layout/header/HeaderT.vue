    ...
    <div class="a-container">
      ...
      <div v-show="!$store.state.search.searchBarVisible" class="a-flex">
        <div class="a-flex-left">
          <menu-button height="22" color="var(--c-gray-1)" px="15" py="0" :action="toggleMenuDrawer" />
        ...
        <search-bar 
          @showSearchbar="clickHandler(showSearchBar)"
        />
      </div>
    </div>
    <divider />
...
export default {
  components: { Divider, MenuButton, HomeButton, CartButton, ProfileButton, SearchButton, RegionalButton, SearchCloseButton, SearchBar, SearchBarMT },
  methods: {
    clickHandler,
    toggleMenuDrawer(){
