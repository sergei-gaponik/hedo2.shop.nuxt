  ...
  <div>
    <div class="a-footer">
      <div class="a-footer-inner">
        ...
        <div
          class="a-tags hide-scrollbar"
          v-if="$store.state.nav.footerTagsVisible"
        >
          <footer-tag
...
import FooterTag from "./FooterTag.vue";
...
.a-tags {
  width: calc(100% - var(--padding-x-m) - 52px);
  display: flex;
  overflow: scroll;
  align-items: center;
  gap: 5px;
